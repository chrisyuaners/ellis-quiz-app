...
c1 = Card.create(question: "What is the political party of the President now?", answer: "Republican", description: "The Republican Party, also referred to as the GOP (Grand Old Party), is one of the two major political parties in the United States; the other is its historic rival, the Democratic Party.", category: "Government")

c2 = Card.create(question: "We elect a President for how many years?", answer: "4", description: "Presidential elections take place every 4 years during the month of November.", category: "Government")

c3 = Card.create(question: "What did Martin Luther King Jr. do?", answer: "Fought for civil rights", description: "Martin Luther King Jr. (January 15, 1929 – April 4, 1968) was an American Baptist minister and activist who became the most visible spokesperson and leader in the civil rights movement from 1955 until his assassination in 1968.", category: "History")

c4 = Card.create(question: "The House of Representatives has how many voting members?", answer: "435", description: "The United States House of Representatives is the lower house of the United States Congress, the Senate being the upper house. Together they compose the national legislature of the United States. The House is composed of representatives who sit in congressional districts that are allocated to each of the 50 states on a basis of population as measured by the U.S. Census, with each district entitled to one representative. Since its inception in 1789, all representatives have been directly elected. The total number of voting representatives is fixed by law at 435.", category: "Government")

c5 = Card.create(question: "What does the judicial branch do?", answer: "Explains laws", description: "The judicial branch is the system of federal courts and judges that interprets (explains) laws made by the legislative branch and enforced by the executive branch. The branch also reviews laws, resolves disputes and decides if the law goes against the Constitution.", category: "Government")

c6 = Card.create(question: "Name one of the longest rivers in the United States", answer: "Missouri River", description: "The Missouri River is the longest river in North America. Mississippi River is the second longest.", category: "Geography")

c7 = Card.create(question: "How many amendments does the Constitution have?", answer: "27", description: "A constitutional amendment is a modification of the constitution of a polity, organization or other type of entity. The first 10 amendments are called Bill of Rights.", category: "Government")

c8 = Card.create(question: "Which of these is something Benjamin Franklin is known for?", answer: "He was the nation’s first postmaster general", description: "The postmaster general of the United States is the chief executive officer of the United States Postal Service. Benjamin Franklin was appointed by the Continental Congress as the first postmaster general in 1775, serving just over 15 months. Franklin had previously served as deputy postmaster for the British colonies of North America since 1753. Franklin was famous for his curiosity in electricity and experimenting with lightning, but did not discover electricity.", category: "History")

c9 = Card.create(question: "Who was President during World War I?", answer: "Woodrow Wilson", description: "Woodrow Wilson (1856-1924), the 28th U.S. president, served in office from 1913 to 1921 and led America through World War I (1914-1918). Wilson sought to maintain American neutrality after the outbreak of World War One and was re-elected president in 1916 on the slogan 'He Kept Us Out of War'.", category: "History")

c10 = Card.create(question: "Which statement correctly describes the 'rule of law'?", answer: "No one is above the law", description: "Rule of law additionally states that everyone must follow the law, leaders must obey the law, and the government must obey the law.", category: "Government")

c11 = Card.create(question: "What ocean is on the West Coast of the United States?", answer: "Pacific Ocean", description: "The Pacific Ocean is the largest and deepest of Earth's oceanic divisions. It extends from the Arctic Ocean in the north to the Southern Ocean in the south and is bounded by Asia and Australia in the west and the Americas in the east.", category: "Geography")

c12 = Card.create(question: "Which of the following is a U.S. territory?", answer: "Guam", description: "Other U.S. territories include Puerto Rico, U.S. Virgin Islands, American Samoa, and Northern Mariana Islands.", category: "Geography")
